...
contract SupplyChain {
    ...
    constructor() public {
        ...
        skuCount = 0; // is not necessary since the default for uint type is 0
    }
    ...
    function shipItem(uint256 _sku) public verifyCaller(items[_sku].seller) sold(_sku) {
    ...
    // 3. Call the event associated with this function!
    function receiveItem(uint256 _sku) public verifyCaller(items[_sku].buyer) shipped(_sku) {
